...
def navi (email, password):
    ...
    # exemple : https://open.spotify.com/playlist/5UsnYdUjn9I9uDK4ZzcUZV
    ...
    bouton_play = driver.find_element_by_xpath('/html/body/div[4]/div/div[2]/div[2]/footer/div/div[2]/div/div[1]/button[3]')
    bouton_play.click()
    
options = Options()
options.add_experimental_option('useAutomationExtension', False)
# veuillez renseigner votre chemin vers votre chromedriver dans les guillemets
# exemple : '/Users/aveyronvictor/Documents/GINFO/Automatisation-/chromedriver-1'
driver = webdriver.Chrome('/Users/aveyronvictor/Documents/GINFO/Automatisation-/chromedriver-1', options=options)
...
navi("obt64512@zwoho.com", "azerty123")